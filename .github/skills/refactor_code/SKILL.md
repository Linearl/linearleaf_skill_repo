---
name: refactor-code
description: 系统化代码重构和架构改进。当用户需要代码重构、系统重构、架构改进、代码重构计划、清理技术债务时激活。Systematic code refactoring and architecture improvement. Activates when user needs code refactoring, system refactoring, architecture improvement, refactor plan, or cleaning technical debt.
---
