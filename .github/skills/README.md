# Copilot Skills Overview

本目录包含本项目的 Copilot Agent Skills。每个子目录代表一个技能包，内部提供该技能的 `SKILL.md` 与说明文档。
...
- [skill_builder](skill_builder) — 技能构建与模板化产出
- [version_compare](version_compare) — 版本对比与差异分析

## Usage

- 每个技能目录下的 `SKILL.md` 为入口说明。
- 可根据任务选择对应技能目录进行参考。
